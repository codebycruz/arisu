...
---@class Context
---@field new fun(window: winit.Window, sharedCtx: Context?): Context
...
local Context = util.isWindows() and require("arisu.context.win32") or require("arisu.context.x11") --[[@as Context]]
