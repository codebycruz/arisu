  ...
  return Element.new("div")
    ...
    :withChildren({
                    ...
                    :withChildren({
                      Element.new("div")
                        ...
                        :withChildren({
                          ...
                          Element.from("Cut"):withStyle({ fg = disabledColor, height = { rel = 1.0 } }),
                        }),
                      Element.new("div")
                        :withStyle({
                          direction = "row",
                        ...
                        :withChildren({
                          ...
                          Element.from("Copy"):withStyle({ fg = disabledColor, height = { rel = 1.0 } }),
                        }),
                    }),
                }),
                    ...
                    :withChildren({
                      Element.new("div")
                        ...
                        :withChildren({
                          ...
                          Element.from("Crop"):withStyle({ fg = disabledColor, height = { rel = 1.0 } }),
                        }),
                      Element.new("div")
                        :withStyle({
                          direction = "row",
                        ...
                        :withChildren({
                          ...
                          Element.from("Resize"):withStyle({ fg = disabledColor, height = { rel = 1.0 } }),
                        }),
                      Element.new("div")
                        :withStyle({
                          direction = "row",
                        ...
                        :withChildren({
                          ...
                          Element.from("Rotate"):withStyle({ fg = disabledColor, height = { rel = 1.0 } }),
                        }),
                    }),
                }),
      ...
      Element.new("div")
        ...
        :withChildren({
          Element.from("arisu v0.2.0"):withStyle({
            align = "center",
            padding = { left = 10 },
          }),
        }),
...
function App:update(message, window)
  if message.type == "StartDrawing" then
    if self.selectedTool == "fill" then
      self.compute:fill((message.x / message.elementWidth) * 800, (message.y / message.elementHeight) * 600, self.currentColor)
